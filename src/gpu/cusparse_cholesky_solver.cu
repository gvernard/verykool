...
public:
  ...
  {
    cusolverSpXcsrcholDiag(handle_,info_,diag);
  }
...
public:
  ...
  void diagonal(T* diag) override
  {
    cholesky.diagonal(d_diag.data);
    d_diag.download(diag);
  }
